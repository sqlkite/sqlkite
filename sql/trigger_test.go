...
func Test_TableAccessTrigger_Without_When(t *testing.T) {
	...
	assert.Equal(t, buffer.MustString(), `create trigger sqlkite_row_access before insert
...
func Test_TableAccessTrigger_With_When(t *testing.T) {
	...
	assert.Equal(t, buffer.MustString(), `create trigger sqlkite_row_access before update
