...
func Test_JoinableFrom_TableName(t *testing.T) {
	sf := JoinableFrom{Table: TableName{Name: "table1", Alias: nil}}
	assert.Equal(t, sf.TableName(), "table1")
}

func Test_JoinableFrom_Write(t *testing.T) {
	tests.AssertSQL(t, JoinableFrom{
		Table: TableName{Name: "table1", Alias: nil},
	}, "table1")

	tests.AssertSQL(t, JoinableFrom{
		Table: TableName{Name: "table1", Alias: &Alias{Alias: "t1"}},
	}, "table1 as t1")
	...
	tests.AssertSQL(t, JoinableFrom{
		Join:  JOIN_TYPE_FULL,
		Table: TableName{Name: "table1", Alias: &Alias{Alias: "tt"}},
...
func Test_Select_Write_NoWhere_NoOrderBy(t *testing.T) {
	tests.AssertSQL(t, Select{
		...
		Froms: []JoinableFrom{
			JoinableFrom{Table: TableName{Name: "table1", Alias: nil}},
		},
		Limit: 100,
...
func Test_Select_Write_MultipleColumn_MultipleFrom(t *testing.T) {
	tests.AssertSQL(t, Select{
		...
		Froms: []JoinableFrom{
			JoinableFrom{Table: TableName{Name: "table1", Alias: &Alias{"t1"}}},
			JoinableFrom{
				Table: TableName{Name: "table2", Alias: &Alias{"t2"}},
				Join:  JOIN_TYPE_INNER,
				On: &Condition{
					Parts: []Part{Predicate{
...
func Test_Select_Multiple_CTE(t *testing.T) {
	sel := Select{
		...
		Froms: []JoinableFrom{
			JoinableFrom{Table: TableName{Name: "table1", Alias: &Alias{"t1"}}},
			JoinableFrom{Join: JOIN_TYPE_LEFT, Table: TableName{Name: "table2", Alias: nil}},
			JoinableFrom{Join: JOIN_TYPE_LEFT, Table: TableName{Name: "table3", Alias: nil}},
		},
	}
